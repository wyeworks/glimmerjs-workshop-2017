function getDrawPots() {
  return [
    [
      { name: 'Rusia', confederation: 'UEFA' },
      { name: 'Alemania', confederation: 'UEFA' },
      { name: 'Polonia', confederation: 'UEFA' },
